...
class TestMakeVarMap_LinuxLEx64_Clang_14_0_0_Dwarf4(BaseTestAppMakeVarmapTest, ScrutinyUnitTest):
    bin_filename = get_artifact('testapp20251229_UbuntuLEx64_clang14_0_0-dwarf4')
    memdump_filename = get_artifact('testapp20251229_UbuntuLEx64_clang14_0_0-dwarf4.memdump')
