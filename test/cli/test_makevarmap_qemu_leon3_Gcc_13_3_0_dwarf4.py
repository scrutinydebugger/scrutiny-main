...
from test.cli.base_testapp_makevarmap_test import BaseVarmapTest
...
class TestMakeVarMap_CPP_QEMU_LEON3_Gcc_13_3_0_Dwarf4(BaseVarmapTest, ScrutinyUnitTest):
    ...
    def test_file3_union(self):
        ...
        vu16 = self.assert_var('/global/file3_union/u16_var', EmbeddedDataType.uint16, value_at_loc=0x99BB)
        vu32 = self.assert_var('/global/file3_union/u32_var', EmbeddedDataType.uint32, value_at_loc=0x99BB5678)
        ...
        v3 = self.assert_var('/global/file3_anonbitfield_in_union/val', EmbeddedDataType.uint8, value_at_loc=0x57)
        ...
        self.assert_var('/global/file3_test_class/m_file3_complex_struct/field3/field3_u16/p0', EmbeddedDataType.uint16, value_at_loc=0x14DE)
        self.assert_var('/global/file3_test_class/m_file3_complex_struct/field3/field3_u32', EmbeddedDataType.uint32, value_at_loc=0x14DE56AA)
    ...
    def test_file4(self):
        ...
        self.assert_var('/global/file4classA3_array/file4classA3_array[0][0]/the_union/u8/u8[0]', EmbeddedDataType.uint8, value_at_loc=0x12)
        self.assert_var('/global/file4classA3_array/file4classA3_array[0][0]/the_union/u8/u8[1]', EmbeddedDataType.uint8, value_at_loc=0x34)
        self.assert_var('/global/file4classA3_array/file4classA3_array[0][0]/the_union/u8/u8[2]', EmbeddedDataType.uint8, value_at_loc=0x56)
        self.assert_var('/global/file4classA3_array/file4classA3_array[0][0]/the_union/u8/u8[3]', EmbeddedDataType.uint8, value_at_loc=0x78)
        ...
        self.assert_var('/global/file4classA3_array/file4classA3_array[0][1]/the_union/u8/u8[0]', EmbeddedDataType.uint8, value_at_loc=0xAA)
        self.assert_var('/global/file4classA3_array/file4classA3_array[0][1]/the_union/u8/u8[1]', EmbeddedDataType.uint8, value_at_loc=0xBB)
        self.assert_var('/global/file4classA3_array/file4classA3_array[0][1]/the_union/u8/u8[2]', EmbeddedDataType.uint8, value_at_loc=0xCC)
        self.assert_var('/global/file4classA3_array/file4classA3_array[0][1]/the_union/u8/u8[3]', EmbeddedDataType.uint8, value_at_loc=0xDD)
        ...
        self.assert_var('/global/file4classA3_array/file4classA3_array[1][0]/the_union/u8/u8[0]', EmbeddedDataType.uint8, value_at_loc=0x11)
        self.assert_var('/global/file4classA3_array/file4classA3_array[1][0]/the_union/u8/u8[1]', EmbeddedDataType.uint8, value_at_loc=0x22)
        self.assert_var('/global/file4classA3_array/file4classA3_array[1][0]/the_union/u8/u8[2]', EmbeddedDataType.uint8, value_at_loc=0x33)
        self.assert_var('/global/file4classA3_array/file4classA3_array[1][0]/the_union/u8/u8[3]', EmbeddedDataType.uint8, value_at_loc=0x44)
        ...
        self.assert_var('/global/file4classA3_array/file4classA3_array[1][1]/the_union/u8/u8[0]', EmbeddedDataType.uint8, value_at_loc=0x55)
        self.assert_var('/global/file4classA3_array/file4classA3_array[1][1]/the_union/u8/u8[1]', EmbeddedDataType.uint8, value_at_loc=0x66)
        self.assert_var('/global/file4classA3_array/file4classA3_array[1][1]/the_union/u8/u8[2]', EmbeddedDataType.uint8, value_at_loc=0x77)
        self.assert_var('/global/file4classA3_array/file4classA3_array[1][1]/the_union/u8/u8[3]', EmbeddedDataType.uint8, value_at_loc=0x88)
    ...
    def test_file5(self):
        ...
        self.assert_var('/global/File5NamespaceA/file5_structA/i32_ptr', EmbeddedDataType.ptr32,
        ...
        self.assert_var('/global/File5NamespaceA/file5_structB/structA_ptr', EmbeddedDataType.ptr32, value_at_loc=StructAAddresses.base)
        ...
        # Test addresses
        self.assert_var('/global/File5NamespaceB/file5i64_ptr', EmbeddedDataType.ptr32,
                        value_at_loc=self.varmap.get_var('/global/File5NamespaceA/file5i64').get_address())
        self.assert_var('/global/File5NamespaceB/file5i32_ptr', EmbeddedDataType.ptr32,
                        value_at_loc=self.varmap.get_var('/global/File5NamespaceA/file5i32').get_address())
        self.assert_var('/global/File5NamespaceB/file5i16_ptr', EmbeddedDataType.ptr32,
                        value_at_loc=self.varmap.get_var('/global/File5NamespaceA/file5i16').get_address())
        self.assert_var('/global/File5NamespaceB/file5i8_ptr', EmbeddedDataType.ptr32,
                        value_at_loc=self.varmap.get_var('/global/File5NamespaceA/file5i8').get_address())

        self.assert_var('/global/File5NamespaceB/file5u64_ptr', EmbeddedDataType.ptr32,
                        value_at_loc=self.varmap.get_var('/global/File5NamespaceA/file5u64').get_address())
        self.assert_var('/global/File5NamespaceB/file5u32_ptr', EmbeddedDataType.ptr32,
                        value_at_loc=self.varmap.get_var('/global/File5NamespaceA/file5u32').get_address())
        self.assert_var('/global/File5NamespaceB/file5u16_ptr', EmbeddedDataType.ptr32,
                        value_at_loc=self.varmap.get_var('/global/File5NamespaceA/file5u16').get_address())
        self.assert_var('/global/File5NamespaceB/file5u8_ptr', EmbeddedDataType.ptr32,
                        value_at_loc=self.varmap.get_var('/global/File5NamespaceA/file5u8').get_address())

        self.assert_var('/global/File5NamespaceB/file5_structA_ptr', EmbeddedDataType.ptr32, value_at_loc=StructAAddresses.base)
        self.assert_var('/global/File5NamespaceB/file5_structB_ptr', EmbeddedDataType.ptr32, value_at_loc=StructBAddresses.base)

        self.assert_var(
            '/global/File5NamespaceA/file5_structb_array/file5_structb_array[0]/structA_ptr',
            EmbeddedDataType.ptr32,
        ...
        self.assert_var('/global/File5NamespaceB/*file5_structB_array_ptr/structA_ptr', EmbeddedDataType.ptr32, value_at_loc=StructAAddresses.base)
