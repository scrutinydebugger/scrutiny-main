#    test_makevarmap_demo_atmega2560_LE_avr_gcc_5_4_0.py
#        Test suite parse the debug symbols of the ATMega2560 demo
#
...
KNOWN_ENUMS: KnownEnumTypedDict = {
    ...
    "SupportedTriggerConditions": {
        "name": "eSupportedTriggerConditions",
        "values": {
            "AlwaysTrue": 0,
            "Equal": 1,
            "NotEqual": 2,
...
class TestMakeVarMap_ATMega2560_LE_avr_gcc_5_4_0(BaseVarmapTest, ScrutinyUnitTest):
    bin_filename = get_artifact(os.path.join('demos_prebuilt', 'atmega_2560', 'scrutiny-nsec2024.elf'))
    ...
    def test_loop_handlers(self):
        ...
        self.assert_var('/global/task_idle_loop_handler/m_main2loop_msg/m_written', EmbeddedDataType.bool8)
        ...
        self.assert_var('/global/task_idle_loop_handler/m_loop2main_msg/m_written', EmbeddedDataType.bool8)
        ...
        self.assert_var('/global/task_idle_loop_handler/m_datalogger_data_acquired', EmbeddedDataType.bool8)
        self.assert_var('/global/task_idle_loop_handler/m_support_datalogging', EmbeddedDataType.bool8)
        ...
        self.assert_var('/global/task_100hz_loop_handler/m_main2loop_msg/m_written', EmbeddedDataType.bool8)
        ...
        self.assert_var('/global/task_100hz_loop_handler/m_loop2main_msg/m_written', EmbeddedDataType.bool8)
        ...
        self.assert_var('/global/task_100hz_loop_handler/m_datalogger_data_acquired', EmbeddedDataType.bool8)
        self.assert_var('/global/task_100hz_loop_handler/m_support_datalogging', EmbeddedDataType.bool8)
        ...
        self.assert_var('/global/task_20hz_loop_handler/m_main2loop_msg/m_written', EmbeddedDataType.bool8)
        ...
        self.assert_var('/global/task_20hz_loop_handler/m_loop2main_msg/m_written', EmbeddedDataType.bool8)
        ...
        self.assert_var('/global/task_20hz_loop_handler/m_datalogger_data_acquired', EmbeddedDataType.bool8)
        self.assert_var('/global/task_20hz_loop_handler/m_support_datalogging', EmbeddedDataType.bool8)

    def test_main_handler(self):
        self.assert_var("/static/scrutiny_integration.cpp/config/m_rx_buffer", EmbeddedDataType.ptr32)
        self.assert_var("/static/scrutiny_integration.cpp/config/m_rx_buffer_size", EmbeddedDataType.uint16)
        self.assert_var("/static/scrutiny_integration.cpp/config/m_tx_buffer", EmbeddedDataType.ptr32)
        self.assert_var("/static/scrutiny_integration.cpp/config/m_tx_buffer_size", EmbeddedDataType.uint16)
        self.assert_var("/static/scrutiny_integration.cpp/config/m_forbidden_address_ranges", EmbeddedDataType.ptr32)
        self.assert_var("/static/scrutiny_integration.cpp/config/m_forbidden_range_count", EmbeddedDataType.uint8)
        self.assert_var("/static/scrutiny_integration.cpp/config/m_readonly_address_ranges", EmbeddedDataType.ptr32)
        self.assert_var("/static/scrutiny_integration.cpp/config/m_readonly_range_count", EmbeddedDataType.uint8)
        self.assert_var("/static/scrutiny_integration.cpp/config/m_rpvs", EmbeddedDataType.ptr32)
        self.assert_var("/static/scrutiny_integration.cpp/config/m_rpv_count", EmbeddedDataType.uint16)
        self.assert_var("/static/scrutiny_integration.cpp/config/m_rpv_read_callback", EmbeddedDataType.ptr32)
        self.assert_var("/static/scrutiny_integration.cpp/config/m_rpv_write_callback", EmbeddedDataType.ptr32)
        self.assert_var("/static/scrutiny_integration.cpp/config/m_loops", EmbeddedDataType.ptr32)
        self.assert_var("/static/scrutiny_integration.cpp/config/m_loop_count", EmbeddedDataType.uint8)
        self.assert_var("/static/scrutiny_integration.cpp/config/m_user_command_callback", EmbeddedDataType.ptr32)
        self.assert_var("/static/scrutiny_integration.cpp/config/m_datalogger_buffer", EmbeddedDataType.ptr32)
        self.assert_var("/static/scrutiny_integration.cpp/config/m_datalogger_buffer_size", EmbeddedDataType.uint16)
        self.assert_var("/static/scrutiny_integration.cpp/config/m_datalogger_trigger_callback", EmbeddedDataType.ptr32)
        ...
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_comm_handler/m_enabled", EmbeddedDataType.bool8)
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_comm_handler/m_session_id", EmbeddedDataType.uint32)
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_comm_handler/m_session_active", EmbeddedDataType.bool8)
        ...
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_comm_handler/m_first_heartbeat_received", EmbeddedDataType.bool8)
        ...
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_comm_handler/m_request_received", EmbeddedDataType.bool8)
        ...
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_processing_request", EmbeddedDataType.bool8)
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_disconnect_pending", EmbeddedDataType.bool8)
        ...
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_config/memory_write_enable", EmbeddedDataType.bool8)
        ...
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_enabled", EmbeddedDataType.bool8)
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_process_again_timestamp_taken", EmbeddedDataType.bool8)
        ...
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/datalogger/m_manual_trigger", EmbeddedDataType.bool8)
        ...
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/datalogger/m_config_valid", EmbeddedDataType.bool8)
        ...
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/datalogger/m_encoder/m_reader/m_finished", EmbeddedDataType.bool8)
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/datalogger/m_encoder/m_reader/m_read_started", EmbeddedDataType.bool8)
        ...
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/datalogger/m_encoder/m_full", EmbeddedDataType.bool8)
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/datalogger/m_encoder/m_error", EmbeddedDataType.bool8)
        ...
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/datalogger/m_trigger/previous_val", EmbeddedDataType.bool8)
        ...
        self.assert_var(
            "/static/scrutiny_integration.cpp/main_handler/m_datalogging/datalogger/m_trigger/conditions/m_data/cmt/initialized", EmbeddedDataType.bool8)
        ...
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/request_arm_trigger", EmbeddedDataType.bool8)
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/request_ownership_release", EmbeddedDataType.bool8)
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/request_disarm_trigger", EmbeddedDataType.bool8)
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/pending_ownership_release", EmbeddedDataType.bool8)
        self.assert_var("/static/scrutiny_integration.cpp/main_handler/m_datalogging/reading_in_progress", EmbeddedDataType.bool8)
    ...
    def test_scrutiny_integration(self):
        self.assert_var(
            "/static/scrutiny_integration.cpp/rpv_write_callback(scrutiny::RuntimePublishedValue, scrutiny::ctypes::scrutiny_c_any_type_t const*, scrutiny::LoopHandler*)/some_counter", EmbeddedDataType.uint32)
    ...
    def test_bno055(self):
        ...
        self.assert_var('/global/bno055/m_double_buffer_flag', EmbeddedDataType.bool8)
        ...
        self.assert_var('/global/bno055/m_i2c_rx_buffer/m_i2c_rx_buffer[0][0]', EmbeddedDataType.uint8)
        self.assert_var('/global/bno055/m_i2c_rx_buffer/m_i2c_rx_buffer[0][7]', EmbeddedDataType.uint8)
        self.assert_var('/global/bno055/m_i2c_rx_buffer/m_i2c_rx_buffer[1][0]', EmbeddedDataType.uint8)
        self.assert_var('/global/bno055/m_i2c_rx_buffer/m_i2c_rx_buffer[1][7]', EmbeddedDataType.uint8)
        self.assert_var('/global/bno055/m_i2c_data_available', EmbeddedDataType.bool8)
