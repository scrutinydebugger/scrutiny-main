...
class TestMakeVarMap_CPP_LinuxLEx64_Gcc11_4_0_Dwarf3(BaseTestAppMakeVarmapTest, ScrutinyUnitTest):
    bin_filename = get_artifact('testapp20251231_UbuntuLEx64_gcc11_4_0-dwarf3')
    memdump_filename = get_artifact('testapp20251231_UbuntuLEx64_gcc11_4_0-dwarf3.memdump')
