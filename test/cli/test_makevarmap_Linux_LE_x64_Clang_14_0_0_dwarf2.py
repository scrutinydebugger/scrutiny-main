...
class TestMakeVarMap_LinuxLEx64_Clang_14_0_0_Dwarf2(BaseTestAppMakeVarmapTest, ScrutinyUnitTest):
    bin_filename = get_artifact('testapp20251231_UbuntuLEx64_clang14_0_0-dwarf2')
    memdump_filename = get_artifact('testapp20251231_UbuntuLEx64_clang14_0_0-dwarf2.memdump')
