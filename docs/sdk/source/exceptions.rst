...
All exceptions thrown by the Scrutiny Python :abbr:`SDK (Software Development Kit)` inherit the common :class:`ScrutinySDKException<scrutiny.sdk.ScrutinySDKException>`.
