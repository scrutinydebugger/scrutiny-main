...
python3 -m coverage run --data-file ${COV_DATAFILE} -m scrutiny runtest server.test_active_sfd_handler.TestActiveSFDHandlerFromTestApp.test_load_testapp_sfd --loglevel debug
