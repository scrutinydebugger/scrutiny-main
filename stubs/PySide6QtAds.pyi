...
class ads:
    ...
    class CDockWidgetTab(QFrame):
        def __init__(self, DockWidget:ads.CDockWidget, parent:Optional[QWidget] = None) -> None: ...
    ...
    class CDockWidget(QFrame):
        ...
        def __init__(self, dock_manager:ads.CDockManager, title:str, parent:Optional[QWidget] = None) -> None:...
        def minimumSizeHint(self) -> QSize: ...
