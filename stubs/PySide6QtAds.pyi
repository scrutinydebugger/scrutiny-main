...
class ads:
    ...
    class CDockAreaWidget(QFrame):
        ...
        @classmethod
        def restoreState(cls, Stream: ads.CDockingStateReader, CreatedWidget: ads.CDockAreaWidget,
                         Testing: bool, ParentContainer: ads.CDockContainerWidget) -> bool: ...
    ...
    class CDockContainerWidget(QFrame):
        ...
        def addDockWidget(self, area: ads.DockWidgetArea, Dockwidget: ads.CDockWidget,
                          DockAreaWidget: Optional[ads.CDockAreaWidget] = None, Index: int = -1) -> ads.CDockAreaWidget: ...
    ...
    class CDockManager(CDockContainerWidget):
        ...
        class eAutoHideFlag(Enum):
            ...
            # If the flag is set, the auto hide button enables auto hiding for all dock widgets in an area, if disabled, only the current dock widget will be toggled
            AutoHideButtonTogglesArea = 0x04
            # If the flag is set, the auto hide button will be checked and unchecked depending on the auto hide state. Mainly for styling purposes.
        ...
        def addDockWidget(self, area: ads.DockWidgetArea, Dockwidget: ads.CDockWidget,
                          DockAreaWidget: Optional[ads.CDockAreaWidget] = None, Index: int = -1) -> ads.CDockAreaWidget: ...
        def addDockWidgetToContainer(self, area: ads.DockWidgetArea, Dockwidget: ads.CDockWidget,
                                     DockContainerWidget: ads.CDockContainerWidget) -> ads.CDockAreaWidget: ...

        def addAutoHideDockWidget(self, Location: ads.SideBarLocation, Dockwidget: ads.CDockWidget) -> ads.CAutoHideDockContainer: ...
        def addAutoHideDockWidgetToContainer(self, Location: ads.SideBarLocation, Dockwidget: ads.CDockWidget,
                                             DockContainerWidget: ads.CDockContainerWidget) -> ads.CAutoHideDockContainer: ...

        def addDockWidgetTab(self, area: ads.DockWidgetArea, Dockwidget: ads.CDockWidget) -> ads.CDockAreaWidget: ...
        def addDockWidgetTabToArea(self, Dockwidget: ads.CDockWidget, DockAreaWidget: ads.CDockAreaWidget,
                                   Index: int = -1) -> ads.CDockAreaWidget: ...
    ...
    class CDockWidget(QFrame):
        ...
        def __init__(self, dock_manager: CDockManager, title: str, parent: Optional[QWidget] = None) -> None: ...
        def minimumSizeHint(self) -> QSize: ...
